...
class LoanStatementDetails extends StatelessWidget {
  const LoanStatementDetails({Key? key}) : super(key: key);
      ...
      child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 0, right: 8, bottom: 8),
                child: Row(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 0, right: 8, bottom: 10),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
